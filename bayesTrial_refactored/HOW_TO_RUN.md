...
1.  **Open `simulation_notebook.qmd`** in RStudio or your preferred R environment.
...
3.  **Run the Simulation:** Run the code chunks in the notebook sequentially. The notebook will automatically source the necessary files, run the simulation, and generate plots and summary tables.
...
1.  **Open `main.R`** in your R console or RStudio.
...
This will execute the `run_trial_simulation` function with the default parameters defined in `config.R` and save the plots to the `results` directory.
