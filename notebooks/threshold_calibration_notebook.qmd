...
threshold_settings <- list(
  ...
  c_T_candidates = if (quick_mode) seq(0.2, 0.5, by = 0.15) else seq(0.2, 0.5, by = 0.05),
  c_E_candidates = if (quick_mode) seq(0.2, 0.5, by = 0.15) else seq(0.2, 0.5, by = 0.05),
  c_I_candidates = if (quick_mode) seq(0.2, 0.5, by = 0.15) else seq(0.2, 0.5, by = 0.05),
