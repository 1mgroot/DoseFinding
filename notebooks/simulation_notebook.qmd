...
This notebook is the standard user interface for running one Bayesian dose-finding trial simulation. Edit only the **User Settings** chunk, then click **Run All** or **Render** in RStudio. The setup and backend simulation chunks run automatically.

Use quick mode for a fast smoke test. Switch `quick_mode` to `FALSE` when you want the full default stage count.
...
This chunk runs the backend simulation automatically. The workflow is:
