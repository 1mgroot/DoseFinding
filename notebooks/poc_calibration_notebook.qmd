...
This section is skipped unless `run_parameter_search <- TRUE` in **User Settings**. It tests a grid of `c_T`, `c_E`, and `c_I` values while keeping the trial structure, clinical thresholds, utility table, and null scenario fixed.
