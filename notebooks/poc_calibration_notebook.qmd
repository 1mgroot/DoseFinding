...
calibration_params <- list(
  null_p_I = 0.20,      # NULL SCENARIO: True immune response rate (set ABOVE threshold phi_I=0.20)
  null_p_E = 0.25,      # NULL SCENARIO: True efficacy rate (set ABOVE threshold phi_E=0.25)
