...
Run the threshold calibration notebook first when `c_T`, `c_I`, or `c_E` need tuning. This notebook treats those three values as fixed inputs for PoC calibration.
