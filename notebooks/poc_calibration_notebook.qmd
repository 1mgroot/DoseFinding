...
**Note on Output Verbosity:**
- Debug output is minimal by default to avoid console overflow in RStudio
- Only shows first 3 simulations for the first c_poc candidate
- Set `debug_early_termination = TRUE` in the function call below for more detailed examples
