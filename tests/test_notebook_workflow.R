...
test_that("threshold calibration notebook includes calibrated defaults in its grids", {
  ...
  expect_equal(threshold_settings$c_T_start, 0.35)
  expect_equal(threshold_settings$c_E_start, 0.55)
  expect_equal(threshold_settings$c_I_start, 0.45)
  expect_true(threshold_settings$c_T_start %in% threshold_settings$c_T_candidates)
  expect_true(threshold_settings$c_E_start %in% threshold_settings$c_E_candidates)
  expect_true(threshold_settings$c_I_start %in% threshold_settings$c_I_candidates)
